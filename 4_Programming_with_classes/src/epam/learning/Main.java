...
//        #9
        ...
        switch (choice) {
            case (1):
                ...
                author = in.next();
                aggregatorBook.showBookByAuthor(aggregatorBook.getBookByAuthor(author));
//                aggregatorBook.showAuthorBook(author);
                break;
            case (2):
                System.out.println("Please, input publish house");
                System.out.print("publish house = ");
                publishHouse = in.next();
                aggregatorBook.showPublisherHouseBook(publishHouse);
                break;
            case (3):
                System.out.println("Please, input year");
                System.out.print("year = ");
                year = in.nextShort();
                aggregatorBook.showBooksPublishingSinceSomeYear(year);
                break;
        }
